...
declare const Text: ({ children, typeStyle, tag, color, leading, weight, size, font, }: TextProps) => JSX.Element;
...
declare const Container: ({ width, gap, sidePadding, children, }: ContainerProps) => JSX.Element;

declare const getSpaces: () => any;

declare const getTokens: (tokenObject: object, cssProperty?: string) => any;

declare const getTypeStyles: () => any;

declare const stitchesStyles: () => void;

declare const stitchesThemeMap: {
    width: string;
    height: string;
    spaceX: string;
    spaceY: string;
...
declare const stitchesDarkColors: {
    colors: {
        orange1: string;
        orange2: string;
        orange3: string;
