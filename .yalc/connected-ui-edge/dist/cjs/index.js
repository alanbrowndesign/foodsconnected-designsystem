...
const StyledButton = styled(framerMotion.motion.button, {
    // Reset
    border: 0,
    cursor: "pointer",
    typeStyle: "body",
...
const Button = (props) => {
    ...
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: jsxRuntime.jsx(StyledButton, { type: type, 
            // @ts-expect-error
            onClick: onClick, whileHover: {
                scale: 1.05,
            }, whileTap: {
                scale: 0.975,
            }, children: jsxRuntime.jsx("div", { className: "button-inner", children: children }) }) }));
};
Button.defaultProps = {
...
const Text = ({ children, typeStyle, tag, color, leading, weight, size, font, }) => {
    return (jsxRuntime.jsx(StyledText, { typeStyle: typeStyle, color: color, leading: leading, weight: weight, size: size, font: font, as: tag, children: children }));
};
...
const Container = ({ width, gap, sidePadding, children, }) => {
    return (jsxRuntime.jsx(StyledContainer, { width: width, gap: gap, sidePadding: sidePadding, children: children }));
};
...
exports.stitchesDarkColors = stitchesDarkColors;
exports.stitchesMedia = stitchesMedia;
exports.stitchesStyles = stitchesStyles;
exports.stitchesTheme = stitchesTheme;
exports.stitchesThemeMap = stitchesThemeMap;
exports.stitchesUtils = stitchesUtils;
exports.twTheme = twTheme;
exports.twTypeStyles = twTypeStyles;
